...
const Index = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="relative min-h-[100vh] md:h-[600px] flex items-center justify-center hero-bg overflow-hidden">
        <div 
        ...
        <div className="relative z-20 text-center px-4 w-full max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-12 md:mb-8">
